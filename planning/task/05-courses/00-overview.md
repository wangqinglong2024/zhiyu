...
- [ ] CR-18 实现付费墙：每个主题 Stage 4+ 触发，单段/9 段/月/年/半年促销展示，试看不计完成；支付动作走 PaymentAdapter fake。来源句：`CR-FR-010` 与用户裁决“每个主题域的前三个阶段下的全部章都免费”。
...
- [ ] CR-26 后台课程管理使用分层结构：先选 4 主题；主题页左侧 12 阶段、右侧当前阶段 12 章；章编辑子页面左侧 12 节、右侧当前节 12 知识点。来源句：`planning/ux/11-screens-admin.md` “课程层级交互”。
